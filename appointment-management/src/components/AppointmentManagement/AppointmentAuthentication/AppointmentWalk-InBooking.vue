<template>
    <div class="mt-32 w-full flex justify-center h-full">
        <div class="w-4/5 bg-[#E3E4E6] rounded-3xl flex max-sm:flex max-sm:flex-col shadow-2xl max-sm:w-full">
                ...
                <form action="" class="p-3 w-full mt-5">
                    <div v-if="currentStep === 1" class="w-full flex flex-col items-center">
                        <div class="flex flex-row w-full">
                            <div class="flex flex-row max-sm:flex max-sm:flex-col text-left w-full mb-4 p-3 items-center ">
                                <div class="w-4/5 flex flex-col ">
                                    ...
                                    <input required type="text" name="firstname" class="w-4/5 max-sm:w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
                                </div>
                                <div class="w-4/5 flex flex-col">
                        ...
                        <div class="flex w-full ml-6">
                            <input type="checkbox" name="acceptdataprivacy" id="acceptdataprivacy" class="w-4">
                    ...
                    <div>
                        ...
                        <div class="w-full flex flex-col">
                            <div class="flex flex-col max-sm:flex max-sm:flex-col w-full mb-4 p-3">

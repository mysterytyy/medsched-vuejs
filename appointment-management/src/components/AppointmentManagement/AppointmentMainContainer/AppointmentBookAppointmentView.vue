<template>
    <div class="flex flex-col w-full justify-center items-center">
        <div class="flex justify-evenly items-center w-full max-sm:flex max-sm:flex-col max-sm:mt-8">
             <div class="w-1/2 relative max-sm:w-3/4">
             ...
             <div class="w-1/4 max-sm:w-2/3 max-sm:mt-2 flex justify-center p-2 rounded-2xl border border-gray-200 cursor-pointer">   
        ...
        <div class="w-5/6 mt-10 bg-white shadow-md p-3 rounded-lg max-sm:w-full max-sm:p-8 max-sm:h-full ">
           
            <div class="max-sm:w-full">
                <h1 class="text-left ml-5 text-2xl font-normal font-[Poppins] max-sm:text-center max-sm:ml-0">Available Centers</h1>
            </div>
            <div class="flex max-sm:flex max-sm:flex-col justify-center items-center gap-5 m-5 h-1/3 max-sm:h-full font-[Inter] text-xl flex-wrap mt-5">
                <div
                v-for="(center, index) in filteredAvailableServices"
                :key="index"
                class="bg-white max-sm:w-full p-5 h-40 w-1/5 rounded-2xl shadow-xl text-white flex flex-col items-center justify-center transition duration-300 hover:-translate-y-1 hover:scale-110 ease-in-out cursor-pointer border-2 border-sky-400"
                >
        ...
        <div class="w-full mt-10 h-full flex justify-center  ">
            <div class="bg-white w-5/6 rounded-lg shadow-lg max-sm:w-full max-sm:p-8  ">
                <div>
                <h1 class="text-left ml-5 text-2xl font-normal font-[Poppins] max-sm:text-center max-sm:ml-0">Unavailable Centers</h1>
            </div>
            <div class="flex justify-center max-sm:flex max-sm:flex-col max-sm:h-full items-center gap-5 m-5 h-1/3 font-[Inter] text-xl flex-wrap mt-5">
                <div v-for="(center, index) in filteredUnavailableServices" :key="index" class="p-5 h-40 w-1/5 max-sm:w-full rounded-2xl shadow-xl text-white flex flex-col items-center justify-center transition duration-300 hover:-translate-y-1 hover:scale-110 ease-in-out cursor-pointer border-2 border-red-400">

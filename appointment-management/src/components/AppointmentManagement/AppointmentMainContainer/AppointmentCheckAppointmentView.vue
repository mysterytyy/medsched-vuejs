<template>
    <div class="flex flex-col items-center w-full h-screen">
        <div class="w-full mt-10 flex max-sm:flex max-sm:flex-col justify-between ">
            <div class="flex flex-row w-1/3 max-sm:w-full justify-center">
                <h1 class="text-3xl font-bold font-[Poppins] text-left ml-5 max-sm:ml-0">Appointment List |</h1>
                <RefreshSVG />
            </div>
            <div class="w-1/3 flex justify-center max-sm:w-full max-sm:mt-5">
                <button class="bg-sky-400 px-4 py-2 w-5/12 max-sm:w-1/2 max-sm:flex max-sm:justify-center  rounded-lg shadow-lg text-white font-[Inter] flex flex-row justify-center uppercase hover:bg-sky-600 hover:text-white transition duration-300 ease-in-out group">
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700 bg-slate-200 w-full mt-5">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center max-sm:flex max-sm:flex-row max-sm:flex-nowrap max-sm:justify-center" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" data-tabs-active-classes="text-purple-600 hover:text-purple-600 dark:text-purple-500 dark:hover:text-purple-500 border-purple-600 dark:border-purple-500" data-tabs-inactive-classes="dark:border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300" role="tablist">
